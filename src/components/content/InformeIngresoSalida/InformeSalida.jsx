...
import { faEye, faDownload, faPrint, faCopy } from '@fortawesome/free-solid-svg-icons'; import SearchInput, { createFilter } from 'react-search-input';
...
const InformeSalida = (props) => {
    ...
    useEffect(() => {
        const fecthData = async () => {
            try {
                const response = await fetch('https://profinal-production-2983.up.railway.app/listar_ordenesrealizadas.php');
                if (!response.ok) {
